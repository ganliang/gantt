...
"undefined" == typeof window.dhx4 && (window.dhx4 = {
		...
		selectTextRange : function (t, e, n) {
			...
			if (e = Math.max(Math.min(e, i), 0), n = Math.min(n, i), t.setSelectionRange)
				try {
		...
		transDetect : function () {
			if (null == this.transData) {
				...
				for (var e in t)
					0 == this.transData.transProp && null != document.documentElement.style[e] && (this.transData.transProp = e, this.transData.transEv = t[e]);
				t = null
			}
	...
	window.dhx4.isKHTML = navigator.userAgent.indexOf("Safari") >= 0 || navigator.userAgent.indexOf("Konqueror") >= 0, window.dhx4.isFF = navigator.userAgent.indexOf("Firefox") >= 0, window.dhx4.isIPad = navigator.userAgent.search(/iPad/gi) >= 0), "undefined" == typeof window.dhx4.ajax && (window.dhx4.ajax = {
		...
		parse : function (t) {
			if ("string" != typeof t)
				return t;
			if (t = t.replace(/^[\s]+/, ""), window.DOMParser && !dhx4.isIE)
	...
	return "clear" == e ? (t.detachAllEvents(), t.dhxevs = null, t.attachEvent = null, t.detachEvent = null, t.checkEvent = null, t.callEvent = null, t.detachAllEvents = null, void(t = null)) : (t.dhxevs = {
		...
		for (var e in this.dhxevs.data) {
			...
			for (var i in this.dhxevs.data[e])
				i == t ? (this.dhxevs.data[e][i] = null, delete this.dhxevs.data[e][i]) : n++;
		...
		if (t = String(t).toLowerCase(), null == this.dhxevs.data[t])
			return !0;
		var n = !0;
		...
		for (var t in this.dhxevs.data) {
			for (var e in this.dhxevs.data[t])
				this.dhxevs.data[t][e] = null, delete this.dhxevs.data[t][e];
	...
	}), _isFF = !1, _isIE = !1, _isOpera = !1, _isKHTML = !1, _isMacOS = !1, _isChrome = !1, _FFrv = !1, _KHTMLrv = !1, _OperaRv = !1, -1 != navigator.userAgent.indexOf("Macintosh") && (_isMacOS = !0), navigator.userAgent.toLowerCase().indexOf("chrome") > -1 && (_isChrome = !0),
...
(), window.dhtmlx || (window.dhtmlx = {}), function () {
	...
	function e(e) {
		if (c) {
			...
			return dhtmlx.message.keyboard && ((13 == n || 32 == n) && t(c, !0), 27 == n && t(c, !1)),
	...
	function a(t) {
		g.area || (g.area = document.createElement("DIV"), g.area.className = "dhtmlx_message_area", g.area.style[g.position] = "5px",
	...
	g.hide = function (t) {
		...
		e && e.parentNode && (window.setTimeout(function () {
				...
				e = null
			}, 2e3), e.className += " hidden", g.timers[t] && window.clearTimeout(g.timers[t]),
			delete g.pull[t])
	}
}
(), dataProcessor.prototype = {
	...
	setUpdated : function (t, e, n) {
		if (!this._silent_mode) {
			...
			a && "updated" == n && (n = a),
			e ? (this.set_invalid(t, !1), this.updatedRows[i] = t,
				this.obj.setUserData(t, this.action_param, n), this._in_progress[t] && (this._in_progress[t] = "wait")) : this.is_invalid(t) || (this.updatedRows.splice(i, 1), this.obj.setUserData(t, this.action_param, "")),
	...
	afterUpdateCallback : function (t, e, n, i) {
		...
		"wait" != this._in_progress[a] ? (s && this.obj.setUserData(t, this.action_param, ""), delete this._in_progress[a]) : (delete this._in_progress[a], this.setUpdated(e, !0, this.obj.getUserData(t, this.action_param))),
	...
	fullSync : function () {
		return 1 == this._need_update && (this._need_update = !1, this.loadUpdate()),
		!0
	},
	getUpdates : function (t, e) {
		return this._update_busy ? !1 : (this._update_busy = !0, this._loader = this._loader || new dtmlXMLLoaderObject(!0), this._loader.async = !0, this._loader.waitCall = e,
	...
	dhtmlxDnD.prototype = {
		...
		getPosition : function (t) {
			...
			t.pageX || t.pageY ? (e = t.pageX, n = t.pageY) : (t.clientX || t.clientY) && (e = t.clientX + document.body.scrollLeft + document.documentElement.scrollLeft, n = t.clientY + document.body.scrollTop + document.documentElement.scrollTop), {
				x : e,
				y : n
			}
		}
		...
		this._click.gantt_grid_head_cell = dhtmlx.bind(function (t, e, n) {
				...
				if (this.callEvent("onGridHeaderClick", [i, t])) {
					...
					if (this.config.sort) {
						...
						if (a && void 0 !== a.sort && a.sort !== !0 && (s = a.sort, !s))
							return;
	...
	gantt._render_grid_item = function (t) {
		...
		for (var e = this.getGridColumns(), n = [], i = 0; i < e.length; i++) {
			...
			dhtmlx.defined(o.align) && (c += "text-align:" + o.align + ";"),
			a = "<div class='" + d + "' style='" + c + "'>" + _ + s + "</div>",
			n.push(a)
		}
		...
		t.attachEvent("onDragMove", dhtmlx.bind(function (e, n) {
				...
				if (this.isTaskExists(d) || (d = t.lastTaskOfLevel(gantt.config.order_branch_free ? _.$level : 0), d == t.config.id && (d = null)),
					...
					if (l.y + o.offsetHeight / 2 < r) {
						...
						g = this._pull[this._order[c + 1]];
						if (g) {
							if (g.id == _.id)
								return;
							h = g
						} else if (g = this._pull[this._order[c]], i(g, _) && g.id != _.id)
							return void this.moveTask(_.id, -1, this.getParent(g.id))
					}
					for (var c = this.getGlobalTaskIndex(h.id), u = this._pull[this._order[c - 1]], f = 1; (!u || u.id == h.id) && c - f >= 0; )
						u = this._pull[this._order[c - f]], f++;
					if (_.id == h.id)
						return;
	...
	gantt._init_resize = function () {
		...
		e.attachEvent("onDragEnd", dhtmlx.bind(function (t, n) {
				...
				for (var c = _ > 0 ? 1 : -1; _ > 0 && 1 === c || 0 > _ && -1 === c; ) {
					var g = _;
					for (r = 0; d > r; r++) {
						var u = i[r].width + c;
						if ((i[r].min_width && u >= i[r].min_width || !i[r].min_width || h > i[r].width) && (_ -= c, i[r].width = u, 0 == _))
							break
					}
					if (g == _)
						break
	...
	gantt._scale_helpers = {
		...
		initColSizes : function (t, e, n, i) {
			...
			e && t.col_width < e && (t.col_width = e, a = t.col_width * s),
			t.width = [];
		...
		iterateScales : function (t, e, n, i, a) {
			for (var s = e.trace_x, r = t.trace_x, o = n || 0, d = i || r.length - 1, _ = 0, l = 1; l < s.length; l++)
				for (var h = o; d >= h; h++)
					 + r[h] != +s[l] || (a && a.apply(this, [_, l, o, h]), o = h, _ = l)
		},
	...
	gantt._tasks_dnd = {
				...
				if (gantt.isTaskExists(n) && (i = gantt.getTask(n)), !gantt._is_readonly(i) && !this.drag.mode) {
					...
					if (s)
						if (s.mode && s.mode != gantt.config.drag_mode.ignore && gantt.config["drag_" + s.mode]) {
							if (n = gantt.locate(e), i = dhtmlx.copy(gantt.getTask(n) || {}), gantt._is_readonly(i))
		...
		_fix_dnd_scale_time : function (t, e) {
			...
			s = gantt._tasks.step;
			gantt.config.round_dnd_dates || (a = "minute", s = gantt.config.time_step),
	...
	gantt._init_tasks_range = function () {
		...
		this._max_date && this._max_date || (this._min_date = new Date, this._max_date = new Date(this._min_date)),
	...
	gantt._render_tasks_scales = function () {
		...
		if (this._is_chart_visible()) {
			...
			for (var r = this._get_resize_options(), o = r.x ? Math.max(this.config.autosize_min_width, 0) : this.$task.offsetWidth, d = a.prepareConfigs(s, this.config.min_column_width, o, i), _ = this._tasks = d[d.length - 1], l = [], h = this.templates.scale_row_class, c = 0; c < d.length; c++) {
				...
				u = h(d[c]);
				u && (g += " " + u),
				l.push('<div class="' + g + '" style="height:' + d[c].height + "px;line-height:" + d[c].height + 'px">' + this._prepare_scale_html(d[c]) + "</div>")
			}
			t = l.join(""),
	...
	gantt._combine_item_class = function (t, e, n) {
		...
		n == a.drag_id && (i.push("gantt_drag_" + a.drag_mode), a.touch_drag && i.push("gantt_touch_" + a.drag_mode));
	...
	gantt._task_renderer = function (t, e, n, i) {
		...
		this._task_area_renderers[t] ? this._task_area_renderers[t] : (e || dhtmlx.assert(!1, "Invalid renderer call"), n && n.setAttribute(this.config.layer_attribute, !0), this._task_area_renderers[t] = {
	...
	gantt._process_loading = function (t) {
		...
		for (var e, n = t.data, i = 0; i < n.length; i++)
			e = n[i], this._init_task(e), this.callEvent("onTaskLoading", [e]) && (this._order_full.push(e.id), this._pull[e.id] = e);
		for (var i in this._pull)
			e = this._pull[i], this.setParent(e, this.getParent(e) || this.config.root_id);
		for (var i = 0; i < this._order_full.length; i++)
			e = this._pull[this._order_full[i]], this._add_branch(e), e.$level = this.calculateTaskLevel(e);
	...
	gantt.json = {
		parse : function (data) {
			...
			"string" == typeof data && (window.JSON ? data = JSON.parse(data) : (gantt._temp = eval("(" + data + ")"), data = gantt._temp || {}, gantt._temp = null)),
	...
	gantt._working_time_helper = {
		...
		is_working_unit : function (t, e, n) {
			...
			return -1 == i && (i = this._check_is_working_unit(t, e, n), this._working_units_cache.put(e, t, i)),
			i
		},
		...
		get_closest_worktime : function (t) {
			...
			for ("past" == t.dir && (_ = -1); !this.is_working_unit(n, e); ) {
				...
				if (n = gantt.date.add(n, _, e), n = gantt._correct_dst_change(n, l, _, e), gantt.date[e + "_start"] && (n = gantt.date[e + "_start"](n)), d && (s ? i = n : a = n), s = !s, o++, o > r)
	...
	gantt.updateTask = function (t, e) {
		...
		this.callEvent("onBeforeTaskUpdate", [t, e]) === !1 ? !1 : (this._pull[e.id] = e, this._is_parent_sync(e) || this._resync_parent(e), this._isAllowedUnscheduledTask(e) && (this._init_task(e), this._sync_links()), this._update_parents(e.id),
	...
	gantt.addTask = function (t, e, n) {
		...
		this.setParent(t, e),
		t = this._init_task(t),
		this.callEvent("onBeforeTaskAdd", [t.id, t]) === !1 ? !1 : (this._pull[t.id] = t, this._add_branch(t, n), this.refreshData(), this._adjust_scales(), this.callEvent("onAfterTaskAdd", [t.id, t]), t.id)
	},
	...
	gantt._getTaskTree = function (t) {
		...
		for (var n = [], i = this.getChildren(e.id), a = 0; a < i.length; a++)
			n.push(i[a]), n = n.concat(this._getTaskTree(i[a]));
		return n
	},
	...
	gantt._deleteTask = function (t, e) {
		...
		this._unset_task(t),
		e || (this.callEvent("onAfterTaskDelete", [t, n]), this.refreshData()),
		!0
	},
	...
	gantt._init_task_timing = function (t) {
		...
		void 0 === t.$rendered_type ? t.$rendered_type = e : t.$rendered_type != e && (delete t.$no_end,
				delete t.$no_start, t.$rendered_type = e),
		void 0 !== t.$no_end && void 0 !== t.$no_start || e == this.config.types.milestone || (e == this.config.types.project ? (t.$no_end = t.$no_start = !0, this._set_default_task_timing(t)) : (t.$no_end = !(t.end_date || t.duration), t.$no_start = !t.start_date, this._isAllowedUnscheduledTask(t) && (t.$no_end = t.$no_start = !1))),
	...
	gantt._update_parents = function (t, e) {
		if (t) {
			for (var n = this.getTask(t), i = this.getParent(n); !n.$no_end && !n.$no_start && i && this.isTaskExists(i); )
				n = this.getTask(i), i = this.getParent(n);
			(n.$no_start || n.$no_end) && (gantt.resetProjectDates(n), e || this.refreshTask(n.id, !0)),
	...
	gantt.sort = function (t, e, n, i) {
		...
		if (o) {
			...
			for (var _ = 0; _ < d.length; _++)
				o[_] = d[_].id, this.sort(t, e, o[_], !0)
		}
		a && this.render()
	},
	...
	gantt._dp_init = function (t) {
		...
		t._getRowData = dhtmlx.bind(function (e, n) {
				...
				return i.$no_start && (i.start_date = "", i.duration = ""),
				i.$no_end && (i.end_date = "", i.duration = ""),
	...
	gantt.updateLink = function (t, e) {
		...
		this.callEvent("onBeforeLinkUpdate", [t, e]) === !1 ? !1 : (this._lpull[t] = e, this._sync_links(), this._render_link(t), this.callEvent("onAfterLinkUpdate", [t, e]), !0)
	},
	...
	gantt.getLightbox = function (t) {
		if (void 0 === t && (t = this.getLightboxType()),
			...
			n && (gantt.config.wide_form = !0, e.className += " gantt_cal_light_full"),
			...
			gantt.config.drag_lightbox && (e.firstChild.onmousedown = gantt._ready_to_dnd,
				...
				return !1
			}, e.firstChild.style.cursor = "pointer", gantt._init_dnd_events()),
	...
	gantt._init_lightbox_events = function () {
		...
		gantt.lightbox_events["default"] = function (t, e) {
			if (e.getAttribute("dhx_button"))
				...
				-1 != s.indexOf("gantt_custom_button") && (-1 != s.indexOf("gantt_custom_button_") ? (n = e.parentNode.getAttribute("index"), a = e.parentNode.parentNode) : (n = e.getAttribute("index"), a = e.parentNode, e = e.firstChild));
	...
	gantt.form_blocks = {
		getTimePicker : function (t, e) {
			...
			for (var o = "", d = 0; d < n.length; d++) {
				...
				case "%Y":
					...
					g,
					u;
					t.year_range && (isNaN(t.year_range) ? t.year_range.push && (g = t.year_range[0], u = t.year_range[1]) : h = t.year_range),
					h = h || 10,
					c = c || Math.floor(h / 2),
					g = g || a.getFullYear() - c,
					u = u || g + h;
		...
		time : {
			render : function (t) {
				...
				return n.push(e),
				t.single_date ? (e = this.form_blocks.getTimePicker.call(this, t, !0), n.push("<span></span>")) : n.push("<span style='font-weight:normal; font-size:10pt;'> &nbsp;&ndash;&nbsp; </span>"),
				n.push(e),
				n.push("</div>"),
				n.join("")
			},
		...
		duration : {
			...
			set_value : function (t, e, n, i) {
				...
				gantt.form_blocks._fill_lightbox_select(o, 0, u, c, r),
				_.value = p,
				a()
			},
	...
	gantt._insert_callback = function (t, e, n, i) {
		...
		"links" == i && (s.add = gantt.addLink, s.isExist = gantt.isLinkExists),
		s.isExist.call(gantt, e) || (a.id = e, s.add.call(gantt, a))
	},
	gantt._delete_callback = function (t, e, n, i) {
		...
		"links" == i && (a["delete"] = gantt.deleteLink, a.isExist = gantt.isLinkExists),
		...
		buttons : {
			...
			"delete" : function (t) {
				...
				gantt._dhtmlx_confirm(e, n, function () {
					...
					e.$new ? (gantt._deleteTask(t, !0), gantt.refreshData()) : gantt.deleteTask(t),
					gantt.hideLightbox()
				})
			}
		}
	...
	gantt.scrollTo = function (t, e) {
		...
		1 * e == e && (this.$task_data.scrollTop = e, this.$grid_data.scrollTop = e, this._save_scroll_state(void 0, e));
	...
	gantt.batchUpdate = function (t) {
		var e,
		n = this._dp && "off" != this._dp.updateMode;
		n && (e = this._dp.updateMode, this._dp.setUpdateMode("off")),
		this._skip_render = !0;
		try {
			t()
		} catch (i) {}
		...
		this._skip_render = !1,
		this.render(),
		n && (this._dp.setUpdateMode(e), this._dp.sendData())
	},
	gantt.date = {
		init : function () {
		...
		parseDate : function (t, e) {
			return "string" == typeof t && (dhtmlx.defined(e) && (e = "string" == typeof e ? dhtmlx.defined(gantt.templates[e]) ? gantt.templates[e] : gantt.date.str_to_date(e) : gantt.templates.xml_date), t = t ? e(t) : null),
			t
		}
	},
	...
	function () {
		...
		gantt._init_template = function (t, e, n) {
			...
			n = n || t,
			this.config[t] && i[n] != this.config[t] && (e && this.templates[n] || (this.templates[n] = this.date.date_to_str(this.config[t]), i[n] = this.config[t])),
		...
		gantt._init_templates = function () {
			...
			dhtmlx.mixin(this.templates, {
				...
				drag_link : function (t, e, n, i) {
					...
					return n && (n = gantt.getTask(n), s += "<b> " + n.text + "</b> " + (i ? a.link_start : a.link_end) + "<br/>"),
					s
				},
	...
	(jQuery),
	window.dhtmlx && (dhtmlx.attaches || (dhtmlx.attaches = {}), dhtmlx.attaches.attachGantt = function (t, e) {
		var n = document.createElement("DIV");
	...
	gantt._touch_events = function (t, e, n) {
			...
			dhtmlxEvent(gantt.$container, t[0], function (t) {
				if (!n(t) && o) {
					...
					if (gantt._tasks_dnd.drag.id || gantt._tasks_dnd.drag.start_drag)
						return gantt._tasks_dnd.on_mouse_move(a), t.preventDefault && t.preventDefault(), t.cancelBubble = !0, !1;
					if (a && _) {
						...
						if (!d && (Math.abs(h) > 5 || Math.abs(c) > 5) && (gantt._touch_scroll_active = d = !0, r = 0, s = gantt.getScrollState()), d) {
							...
							if (s.x != g.x && c > 2 * h || s.y != g.y && h > 2 * c)
								return i(t);
						}
					}
					return i(t)
			...
			if (!n(t)) {
				...
				l = setTimeout(function () {
						...
						!t || gantt._locate_css(_, "gantt_link_control") || gantt._locate_css(_, "gantt_grid_data") || (gantt._tasks_dnd.on_mouse_down(_), gantt._tasks_dnd.drag && gantt._tasks_dnd.drag.start_drag && (a(t),
								gantt._tasks_dnd._start_dnd(_), gantt._touch_drag = !0, gantt.refreshTask(t), gantt._touch_feedback())),
						l = null
		...
		dhtmlxEvent(this.$container, t[2], function (t) {
			if (!n(t)) {
				...
				h && (gantt.refreshTask(gantt.locate(h)), h.parentNode && (h.parentNode.removeChild(h), gantt._touch_feedback())),
